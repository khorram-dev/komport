...
#ifndef __KOMPORT_MDI_H__
#define __KOMPORT_MDI_H__
...
Q_SIGNALS:
    void sigShowPluginConfigPage(QWidget *configpageinterface, int id);
};
...
public:
     ...
     */
    ToolView *createToolView(QWidget *widget, const QString &identifier, KMultiTabBar::KMultiTabBarPosition pos, const QIcon &icon, const QString &text);
